    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 24 }}>
          ...
          <p style={{ fontSize: 13, color: "#666", lineHeight: 1.6 }}>
            You've used your <strong>3 free reports</strong>. Pay a one-time fee to access this valuation instantly.
          </p>
        </div>
        ...
        {fetchError && (
          <div style={{
            ...
            <button onClick={() => window.location.reload()} style={{
              marginTop: 8, color: "#B91C1C", fontWeight: 700,
              background: "none", border: "none",
        ...
        {!loadingSecret && !fetchError && !clientSecret && (
          <p style={{ color: "#DC2626", fontSize: 13 }}>
            ⚠️ Could not load payment form. Please refresh.
          </p>
        )}

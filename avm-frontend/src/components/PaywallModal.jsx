...
//         <select value={role} onChange={(e) => setRole(e.target.value)} disabled={defaultRole === "agent"}
//   style={{ width: "100%", padding: "13px 15px", borderRadius: 8, border: "1px solid #e5e7eb", fontSize: 14, outline: "none", boxSizing: "border-box", fontFamily: "inherit", background: defaultRole === "agent" ? "#f9fafb" : "#fff", color: role ? "#2B2B2B" : "#aaa", cursor: defaultRole === "agent" ? "not-allowed" : "pointer" }}>
//   {defaultRole === "agent" ? (

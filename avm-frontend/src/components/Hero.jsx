...
//   const q = query.trim()
//   if (!q) return
//   window.location.href = `https://beta.acqar.com/chat?q=${encodeURIComponent(q)}`
// }
...
//           className="mx-auto mt-6 max-w-[620px] text-base leading-relaxed text-muted sm:text-lg"
//         >
//           Ask ACQAR anything about a Dubai property — the way you'd ask ChatGPT — and get a straight Buy, Sell, or Invest answer, backed by real transaction data. Built for buyers, sellers, investors, and the brokers who advise them.
//         </Reveal>
...
//               {query === '' && (
//                 <TypingPlaceholder
//                   text="Is a 3-bedroom townhouse in Damac Hills a good investment?"
//                   mobileText="Fair price in Damac Hills?"
//                   className="pointer-events-none absolute inset-y-0 left-0 flex items-center truncate px-1 py-2.5 text-sm text-muted sm:text-base"
//                 />
//               )}
...
export default function Hero() {
  ...
  { text: "Is a 3-bedroom townhouse in Damac Hills a good investment?", mobileText: "Fair price in Damac Hills?" },
  { text: "Should I sell my 2BR in Business Bay now or wait a year?", mobileText: "Sell in Business Bay or wait?" },
  { text: "Is AED 1.8M fair for a 1BR in JVC, or am I overpaying?", mobileText: "Overpaying in JVC?" },
]
...
<Reveal delay={280} className="mt-5 text-xs font-medium uppercase tracking-wide text-muted/70">

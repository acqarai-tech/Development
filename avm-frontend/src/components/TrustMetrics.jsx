...
//               Real DLD transaction data, not guesswork. Every answer is backed by
//               the numbers brokers actually need to close with confidence.
//             </p>
//           </Reveal>
    ...
    <section className="border-y border-line bg-white/60 px-6 py-24">
      <div className="mx-auto grid max-w-[1140px] grid-cols-1 items-center gap-14 md:grid-cols-[1fr_520px]">
        <div>
          ...
          <Reveal delay={100}>
            <p className="mt-4 max-w-[440px] text-base leading-relaxed text-muted">
              Real DLD transaction data, not guesswork.
              Every answer ACQAR gives is backed by the numbers you'd need to make the call yourself.
            </p>
          </Reveal>

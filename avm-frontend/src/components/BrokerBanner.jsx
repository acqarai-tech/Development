...
//           Free for every Dubai broker.
//         </h2>
//         <p className="max-w-[520px] text-base leading-relaxed text-muted">
//           Give your clients a straight, data-backed answer in the time it takes to
//           open a chat. When you close faster, so do we — free for every Dubai
//           broker.
//         </p>
//         <a
...
//         </h2>
//         <p className="max-w-[520px] text-base leading-relaxed text-muted">
//           Your clients ask you for a price opinion, a sell-or-hold call, an investment read. 
//           Put ACQAR in the conversation and back it up with real DLD data in seconds — free for every Dubai broker.
//         </p>
//         <a
...
<p className="max-w-[320px] text-base leading-relaxed text-muted sm:max-w-[520px]">
  ...
  Put ACQAR in the conversation and back it up with real DLD data
  <br className="sm:hidden" />{' '}
  in seconds — free for every Dubai broker.
</p>
        <a
          href="https://beta.acqar.com/chat"
          className="mt-2 cursor-pointer rounded-full bg-accent px-6 py-3 text-sm font-medium text-white shadow-[var(--shadow-glow)] transition-transform duration-200 hover:brightness-105 active:scale-95"

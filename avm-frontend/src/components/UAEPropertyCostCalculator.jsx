...
//   const [priceRaw, setPriceRaw]     = useState("1,500,000");
...
//   return (
//     <div style={{ fontFamily: "'Inter', system-ui, sans-serif", background: "#F5F4F2", minHeight: "100vh", padding: "32px 16px" }}>
...
//                     style={{ padding: "4px 11px", borderRadius: 6, border: "1px solid #E8E8E8", background: price === v ? "#2B2B2B" : "#FAFAFA", color: price === v ? "#fff" : "rgba(43,43,43,.6)", fontSize: 11, fontWeight: 700, cursor: "pointer", transition: "all .12s" }}>
...
//                           <span>25% min</span>
//                           <span style={{ textAlign: "center" }}>UAE Central Bank: 75% expat / 80% UAE national (ready)</span>
//                           <span>85% max</span>
//                         </div>
//                       </div>
//                     )}
...
//                           <button key={o.id} onClick={() => setNocOption(o.id)} style={{ flex: 1, padding: "9px 6px", borderRadius: 8, cursor: "pointer", border: `2px solid ${nocOption === o.id ? "#B87333" : "#E8E8E8"}`, background: nocOption === o.id ? "#FFF8F3" : "#fff", textAlign: "center", transition: "all .12s" }}>
...
//                       <div style={{ fontSize: "clamp(14px,2.5vw,19px)", fontWeight: 800, color: c.dark ? "#fff" : "#1a1a1a", lineHeight: 1.1, fontFamily: "monospace" }}>{c.value}</div>
...
//                           <span style={{ color: "rgba(43,43,43,.65)", fontWeight: 500 }}>{row.label}</span>
//                           <span style={{ fontWeight: 700, fontFamily: "monospace", color: "#2B2B2B" }}>{pct.toFixed(1)}%  ·  {fmtAED(row.amount)}</span>
//                         </div>
...
//                 {/* Round-trip */}
//                 {buying && selling && (
//                   <div style={{ background: "#1a1a1a", borderRadius: 12, padding: "14px 20px", display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
//                     <div>

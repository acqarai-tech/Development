...
const roleBadge = (role) => {
  const map = {
    Investor: { bg:'#FEF3E7', color:C.copper  },
    Buyer:    { bg:'#EEF2FF', color:'#6366F1' },
    Seller:   { bg:'#F0FDF4', color:'#16A34A' },
    Agent:    { bg:'#FFF7ED', color:'#EA580C' },
  };
  return map[role] || { bg:'#F3F3F4', color:C.muted };
};
                ...
                <table style={{ width:'100%', borderCollapse:'collapse', tableLayout:'fixed' }}>
                  ...
                  <tbody>
                    {filteredUsers.length === 0 ? (
                      ...
                      const isPaid      = accountType.toLowerCase() === 'paid';
                        ...
                        >
                          ...
                          <td style={{ padding:'13px 12px', overflow:'hidden' }}>
                            <span
                              ...
                              style={{ fontSize:10, fontWeight:800, color:C.muted, display:'block', overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}
                            >
                              {displayId}
                            </span>
                          </td>
                          ...
                          {/* Reg. Type */}
                          <td style={{ padding:'13px 12px', overflow:'hidden' }}>
                            <span style={{ fontSize:11, fontWeight:800, color: isGmail ? '#EF4444' : '#3B82F6', textTransform:'uppercase', display:'block', overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}>
                              {provider}
                            </span>
                          </td>

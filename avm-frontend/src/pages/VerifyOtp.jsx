...
export default function VerifyOtp() {
  ...
  // ✅ ONLY ADDED: responsive sizing via CSS clamps (UI stays same)
  const R = {
    topPadX: "clamp(14px, 4vw, 28px)",
  ...
  return (
    <div style={styles.page}>
      {/* Top bar */}
      <div style={{ ...styles.topBar, padding: `0 ${R.topPadX}`, gap: 12 }}>
        <div style={styles.brand}>
          <div style={styles.brandMark} aria-hidden="true" />
          <div style={styles.brandText}>ACQAR</div>
        </div>
      ...
      <div style={styles.centerWrap}>
        ...
        <div style={{ ...styles.footer, padding: "0 10px" }}>
          © 2024 ACQAR Technology. Licensed for AI Property Valuations in Dubai, UAE.
        </div>
      </div>
    </div>

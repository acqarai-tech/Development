...
// const PricingSection = ({ onUpgradeClick }) => (
//   <section style={{ backgroundColor: C.bgWhite, padding: "100px 0 0" }}>
//     <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 clamp(1.25rem, 4vw, 2rem)" }}>
...
//       <GlobalStyles />
//       <TerminalTicker />
//      <Navbar onUpgradeClick={() => setShowPaywall(true)} />
//       <main>
//         <HeroSection />
//         <HookSection />
//         <RevelationSection />
...
//        <PricingSection onUpgradeClick={() => setShowPaywall(true)} />
//         <NotForEveryoneSection />
//         <TheCloseSection />
//       </main>
//       <Footer />
//         {showPaywall && <PaywallModal onClose={() => setShowPaywall(false)} defaultRole="agent" />}
//     </>
//   );
// }
...
// const PricingSection = ({ onUpgradeClick, isPro }) => (
//   <section style={{ backgroundColor: C.bgWhite, padding: "100px 0 0" }}>
//     <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 clamp(1.25rem, 4vw, 2rem)" }}>
//       <motion.div {...fadeUp(0)} style={{ textAlign: "center" }}><SectionLabel>YOUR ACCESS</SectionLabel></motion.div>
//       <motion.h2 {...fadeUp(0.08)} style={{ fontFamily: "Inter", fontSize: "clamp(1.9rem, 4.5vw, 3.1rem)", fontWeight: 900, letterSpacing: "-0.03em", color: C.textPrimary, lineHeight: 1.08, marginBottom: "3.25rem", textAlign: "center" }}>
...
//           </p>
//        {isPro ? (
//   <div style={{ textAlign: "center", padding: "14px", backgroundColor: `${C.brand}22`, border: `1px solid ${C.brand}`, borderRadius: "12px", color: C.brand, fontWeight: 900, fontFamily: "Inter", fontSize: "0.85rem", letterSpacing: "0.08em" }}>
//     ✓ YOU'RE ON SIGNAL PRO
//   </div>
// ) : (
//   <CTAButton href="#" size="lg" fullWidth variant="copper" onClick={onUpgradeClick}>
//     Lock AED 29 Forever — Join Signal Pro
...
//       <GlobalStyles />
//       <TerminalTicker />
//       <Navbar onUpgradeClick={() => setShowPaywall(true)} isLoggedIn={isLoggedIn} isPro={isPro} />
//       <main>
//         <HeroSection />
//         <HookSection />
//         <RevelationSection />
//         <SocialProofSection />
//         <BrokerConnectSection />
//         <PricingSection onUpgradeClick={() => setShowPaywall(true)} isPro={isPro} />
//         <NotForEveryoneSection />
//         <TheCloseSection />
//       </main>
//       <Footer />
...
//       <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
//     <CTAButton href={isLoggedIn ? "/dashboard" : "/login"} variant={isLoggedIn ? "copper" : "outline"} size="sm">
//   {isLoggedIn ? "DASHBOARD" : "LOGIN"}
// </CTAButton>
// {!isPro
//   ? <CTAButton href="#" variant="copper" size="sm" onClick={onUpgradeClick}>Get Signal Pro</CTAButton>
...
//       Active as <span style={{ color: "#C8C6C2", fontWeight: 600 }}>your@email.com</span>
//     </p>
  ...
  return (
    <>
      ...
      <main>
        ...
        <SocialProofSection />
        <BrokerConnectSection />
        <PricingSection onUpgradeClick={() => setShowPaywall(true)} isPro={isPro} userEmail={userEmail} />
        <NotForEveryoneSection />
        <TheCloseSection />
      </main>
      <Footer />

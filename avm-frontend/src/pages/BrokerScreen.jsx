...
const AcqarLogo = () => (
  <a href="https://www.acqar.com/" style={{ textDecoration: "none" }}>
    <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
      <span style={{ fontWeight: 900, fontSize: 14, letterSpacing: "0.12em", lineHeight: 1, fontFamily: "Inter, sans-serif" }}>
      ...
      <span style={{
        ...
        <span style={{ fontSize: 11, fontWeight: 700, color: "#B87333", letterSpacing: "1.5px", textTransform: "uppercase" }}>
          SIGNAL™
        </span>
      </span>
    </div>
...
const fz  = { xl: "0.82rem", lg: "0.78rem", md: "0.72rem", sm: "0.65rem" }[size] || "0.72rem";
  ...
  return (
<motion.a href={href} onClick={onClick ? (e) => { e.preventDefault(); onClick(); } : undefined} whileTap={{ scale: 0.96 }} onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)} style={{ ...base, ...(vs[variant] || vs.primary) }}>
      {children}
    </motion.a>
  );
};
...
// NAVBAR
// =============================================================================
const Navbar = ({ onUpgradeClick, isLoggedIn, isPro }) => {
  ...
  return (
   ...
   <CTAButton href={isLoggedIn ? "/dashboard" : "/login"} variant="copper" size="sm">
...
// =============================================================================
const HeroSection = () => {
  const trustItems = ["✓ No credit card", "✓ RERA-registered brokers only", "✓ AED 500M+ analysed on platform", "✓ Live now at acqar.com"];
  ...
  <div style={{ maxWidth: "clamp(220px, 80vw, 400px)", margin: "0 auto" }}>
      ...
      → Get Inside Free — 2 Minutes
        ...
        <motion.div {...fadeUp(0.8)} style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: "24px", padding: "40px 0", borderTop: `1px solid ${C.borderLight}`, borderBottom: `1px solid ${C.borderLight}`, maxWidth: "720px", margin: "3rem auto 0" }}>
          {[
            ...
            { top: "Coverage",  bottom: "AED 500M+ ANALYZED" },
          ].map((item, i) => (
...
const PricingSection = ({ onUpgradeClick, isPro, userEmail }) => (
  <section style={{ backgroundColor: C.bgWhite, padding: "100px 0 0" }}>
    <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 clamp(1.25rem, 4vw, 2rem)" }}>
      ...
      <motion.h2 {...fadeUp(0.08)} style={{ fontFamily: "Inter", fontSize: "clamp(1.9rem, 4.5vw, 3.1rem)", fontWeight: 900, letterSpacing: "-0.03em", color: C.textPrimary, lineHeight: 1.08, marginBottom: "3.25rem", textAlign: "center" }}>
        Two Ways In.{" "}<span style={{ color: C.brand }}>One Expires May 30.</span>
      </motion.h2>
  ...
  <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
    <div style={{ textAlign: "center", padding: "14px", backgroundColor: "rgba(34,197,94,0.12)", border: `2px solid ${C.greenLight}`, borderRadius: "12px", color: C.greenLight, fontWeight: 900, fontFamily: "Inter", fontSize: "0.85rem", letterSpacing: "0.08em", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px" }}>
      <span style={{ width: 20, height: 20, backgroundColor: C.greenLight, borderRadius: "4px", display: "inline-flex", alignItems: "center", justifyContent: "center", color: "#fff", fontSize: "0.75rem" }}>✓</span>
      YOUR CURRENT PLAN
    </div>
    <p style={{ textAlign: "center", color: "#5E5C5A", fontSize: "0.72rem", fontFamily: "Inter" }}>
      Active as <span style={{ color: "#C8C6C2", fontWeight: 600 }}>{userEmail}</span>
    </p>
    <CTAButton href="/dashboard" variant="outlineCopper" size="md" fullWidth>
      GO TO DASHBOARD →
    </CTAButton>
  </div>
) : (
  <CTAButton href="#" size="lg" fullWidth variant="copper" onClick={onUpgradeClick}>
    ...
    <div style={{ maxWidth: "820px", margin: "0 auto" }}>
      ...
      <motion.div {...fadeUp(0.75)} style={{ textAlign: "center" }}>
        ...
        <p style={{ color: C.brand, fontSize: "0.85rem", fontFamily: "Inter", fontWeight: 600, marginTop: "8px" }}>
          Signal Pro Founding Rate: AED 29/month — locks forever. Becomes AED 149 on May 31.
        </p>
  ...
  return (
    <>
      <style>{`
        ...
        .acq-footer-new .inner { max-width: 100%; margin: 0 auto; padding: 48px 80px 32px; }
        .acq-footer-new .main-grid {
          display: grid;
          grid-template-columns: 1.8fr 1fr 1fr 1fr 1fr;
          gap: 32px; margin-bottom: 48px;
        }
        .acq-footer-new .col-heading { display: flex; align-items: center; gap: 8px; margin-bottom: 24px; }
        .acq-footer-new .col-heading-dot { width: 4px; height: 4px; border-radius: 50%; background: #B87333; opacity: 0.7; }
        .acq-footer-new .col-heading h6 { font-size: 11px; font-weight: 900; text-transform: uppercase; letter-spacing: 0.28em; color: #0A0A0A; margin: 0; }
        .acq-footer-new ul { list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 16px; }
        .acq-footer-new ul li { font-size: 11.5px; font-weight: 600; color: rgba(10,10,10,0.55); cursor: pointer; transition: color 0.2s; }
        .acq-footer-new ul li:hover { color: #B87333; }
        .acq-footer-new ul li a { color: inherit; text-decoration: none; }
        ...
        .acq-footer-new .social-btn {
          ...
          color: rgba(10,10,10,0.35); text-decoration: none; transition: all 0.2s;
        }
        .acq-footer-new .social-btn:hover { color: #B87333; border-color: rgba(184,115,51,0.4); }
        .acq-footer-new .bottom-bar {
          border-top: 1px solid rgba(10,10,10,0.06); padding-top: 32px;
          display: flex; align-items: center; justify-content: space-between;
          flex-wrap: wrap; gap: 16px; width: 100%;
        }
        .acq-footer-new .bottom-bar p { font-weight: 700; color: rgba(10,10,10,0.3); text-transform: uppercase; font-size: 10px; letter-spacing: 0.2em; margin: 0; }
        .acq-footer-new .bottom-bar .not-advice { font-weight: 500; color: rgba(10,10,10,0.25); font-size: 10px; margin: 0; }
        .acq-footer-new .bottom-location { display: flex; align-items: center; gap: 12px; }
          ...
          <div className="main-grid">
            ...
            <div>
              ...
              <ul>
                ...
                <li><a href="https://www.acqar.com/" target="_blank" rel="noopener noreferrer">ACQAR SIGNAL™</a></li>
                <li style={{ cursor: 'default' }}>ACQAR PASSPORT™</li>
            ...
            <div>
              ...
              <ul>
                <li><a href="https://www.acqar.com/blogs" target="_blank" rel="noopener noreferrer">Intelligence Blog</a></li>
                <li><a href="https://www.acqar.com/terms" target="_blank" rel="noopener noreferrer">Terms of Use</a></li>
                <li><a href="https://www.acqar.com/terms" target="_blank" rel="noopener noreferrer">Privacy Policy</a></li>
              </ul>
            </div>
...
export default function BrokerScreen() {
  ...
  // 1. Page view
  useEffect(() => {
    trackEvent("page_viewed", { page: "broker_landing" });
  }, []);
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (pct >= 25 && !scrolled[25]) { scrolled[25] = true; trackEvent("scroll_depth", { page: "broker_landing", depth: "25%" }); }
      if (pct >= 50 && !scrolled[50]) { scrolled[50] = true; trackEvent("scroll_depth", { page: "broker_landing", depth: "50%" }); }
      if (pct >= 75 && !scrolled[75]) { scrolled[75] = true; trackEvent("scroll_depth", { page: "broker_landing", depth: "75%" }); }
      if (pct >= 100 && !scrolled[100]) { scrolled[100] = true; trackEvent("scroll_depth", { page: "broker_landing", depth: "100%" }); }
    };
  ...
  useEffect(() => {
    ...
    return () => {
      trackEvent("time_spent", { page: "broker_landing", seconds: Math.round((Date.now() - startTime) / 1000) });
    };
  }, []);
...
if (user) {
  ...
  return (
    <>
      <GlobalStyles />
      <TerminalTicker />
      <Navbar onUpgradeClick={() => { trackEvent("cta_click", { location: "navbar_upgrade", page: "broker_landing" }); setShowPaywall(true); }} isLoggedIn={isLoggedIn} isPro={isPro} />
      <main>
        <HeroSection />
        <HookSection />
        <RevelationSection />
        ...
        <PricingSection onUpgradeClick={() => { trackEvent("cta_click", { location: "pricing_upgrade", page: "broker_landing" }); setShowPaywall(true); }} isPro={isPro} userEmail={userEmail} />
        <NotForEveryoneSection />
        <TheCloseSection />
      </main>
      <Footer />
{showPaywall && <PaywallModal onClose={() => setShowPaywall(false)} defaultRole="Broker / Real Estate Agent" />}
    </>
  );
}

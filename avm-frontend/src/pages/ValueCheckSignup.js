...
export default function ValuCheckOtp() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: UI.BG }}>
      {/* ✅ ADDED: Use your provided header (no UI changes inside OTP card) */}
      <Header />

      {/* ✅ Keep the original OTP layout below, just account for fixed header already via <div className="h-20" /> in Header */}
      <div
        style={{
      ...
      {/* ✅ ADDED: Your provided footer (replaces old single-line copyright block) */}
      <Footer />
    </div>
  );
}

     ...
     <div style={{ padding: "12px 16px 20px", flexShrink: 0, borderTop: "1px solid var(--border)" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <div style={{
            ...
            boxShadow: "0 4px 24px rgba(184,115,51,0.08)",
          }}>
            <input
              ref={inputRef}
              value={input}
            ...
            <button
              ...
              style={{
                ...
                background: loading || !input.trim()
                  ? "var(--dark-3)"
                  : "linear-gradient(135deg, var(--copper-light), var(--copper-dark))",
                color: "#fff",
                border: "none",
                borderRadius: 12,
                fontWeight: 800,
                ...
                boxShadow: loading || !input.trim() ? "none" : "0 4px 12px rgba(184,115,51,0.35)",
              }}
            >
              {loading ? (

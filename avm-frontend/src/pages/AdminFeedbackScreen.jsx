...
//   };
//   const pills = [
//     { key:'too_high', label:'Too High', bg:'#FEE2E2', color:'#DC2626', border:'#FECACA' },
//     { key:'spot_on',  label:'Spot On',  bg:'#D1FAE5', color:'#059669', border:'#A7F3D0' },
//     { key:'too_low',  label:'Too Low',  bg:'#DBEAFE', color:'#2563EB', border:'#BFDBFE' },
//   ];
//   return (
...
// };
// const RATING_MAP = {
//   too_high:  { label:'Too High',  bg:'#FEE2E2', color:'#DC2626', border:'#FECACA' },
//   too_low:   { label:'Too Low',   bg:'#DBEAFE', color:'#2563EB', border:'#BFDBFE' },
//   spot_on:   { label:'Spot On',   bg:'#D1FAE5', color:'#059669', border:'#A7F3D0' },
//   fair:      { label:'Fair',      bg:'#FEF3C7', color:'#D97706', border:'#FDE68A' },
// };
...
//                               <div style={{width:32, height:32, borderRadius:9, background:'#FEF3E7', border:`1px solid #F5DEB3`, display:'flex', alignItems:'center', justifyContent:'center', fontWeight:900, color:C.copper, fontSize:13, flexShrink:0}}>
...
//                           <td style={{padding:'20px 16px', overflow:'hidden'}}>
//                             <div style={{display:'flex', alignItems:'center', gap:8}}>
//                               <div style={{width:28, height:28, borderRadius:7, background:'#FEF3E7', border:`1px solid #F5DEB3`, display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0}}>
//                                 <Home size={13} color={C.copper}/>
//                               </div>

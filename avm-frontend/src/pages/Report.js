...
//     <>
//       <style>{`
//         .acq-footer-new { position:relative; background:#F5F5F4; border-top:1px solid rgba(10,10,10,0.06); font-family:'Inter',sans-serif; }
//         .acq-footer-new .copper-line { position:absolute; top:0; left:0; right:0; height:1px; background:linear-gradient(90deg,transparent 0%,#B87333 35%,#B87333 65%,transparent 100%); }
//         .acq-footer-new .inner { max-width:100%; margin:0 auto; padding:48px 80px 32px; }
//         .acq-footer-new .main-grid { display:grid; grid-template-columns:1.8fr 1fr 1fr 1fr 1fr; gap:32px; margin-bottom:48px; }
...
//         .acq-footer-new ul li.muted { color:rgba(10,10,10,0.55); cursor:default; }
//         .acq-footer-new ul li a { color:inherit; text-decoration:none; transition:color 0.2s; }
//         .acq-footer-new ul li a:hover { color:#B87333; }
//         .acq-footer-new .social-row { display:flex; gap:12px; }
//         .acq-footer-new .social-btn { width:36px; height:36px; border-radius:50%; border:1px solid rgba(10,10,10,0.09); background:rgba(255,255,255,0.6); display:flex; align-items:center; justify-content:center; color:rgba(10,10,10,0.35); text-decoration:none; transition:all 0.2s; }
//         .acq-footer-new .social-btn:hover { color:#B87333; border-color:rgba(184,115,51,0.4); }
//         .acq-footer-new .bottom-bar { border-top:1px solid rgba(10,10,10,0.06); padding-top:32px; display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:16px; width:100%; }
...
//         @media(max-width:1024px){ .acq-footer-new .inner{padding:48px 32px 32px;} .acq-footer-new .main-grid{grid-template-columns:1fr 1fr 1fr;gap:24px;} }
//         @media(max-width:768px){ .acq-footer-new .inner{padding:40px 24px 24px;} .acq-footer-new .main-grid{grid-template-columns:1fr 1fr;gap:32px 16px;} .acq-footer-new .bottom-bar{flex-direction:column;text-align:center;justify-content:center;} .acq-footer-new .bottom-location{justify-content:center;} .acq-footer-new .not-advice{display:none;} }
//         @media(max-width:480px){ .acq-footer-new .inner{padding:40px 16px 20px;} .acq-footer-new .main-grid{grid-template-columns:1fr;gap:28px;} }
//       `}</style>
...
//               <ul>{['About ACQAR', 'Contact Us'].map(l => (<li key={l}>{l}</li>))}</ul>
//             </div>
//             <div>
...
//               <ul>{['vs Bayut TruEstimate', 'vs Property Finder', 'vs Traditional Valuers', 'Why ACQAR?'].map(l => (<li key={l}>{l}</li>))}</ul>
//             </div>
//           </div>
...
//                 {/* ── 3-YEAR FORECAST ── */}
//                 {Number.isFinite(totalVal) && totalVal > 0 ? <PricePredictionChart currentValue={totalVal} /> : null}
...
//                         onClick={() => { setFbRating(b.rating); setFbNote(""); setFbStar(0); setFbStarHover(0); setFbStep("form"); }}>
//                         {b.icon}{b.label}
//                       </button>
//                     ))}
//                   </div>
...
//                     <span className="vcRewardBadge">🎁 Community Reward</span>
//                     <h3 className="vcFeedbackTitle" style={{ marginBottom: 8 }}>Was our valuation accurate?</h3>
//                     <p className="vcFeedbackText">Help us improve our AI engine. Submit a 10-second feedback and unlock <a href="#">ACQAR Pro for 1 month</a>.</p>
//                   </div>
//                   <div className="vcFbRight">
//                     {[
//                       { label: "TOO HIGH", rating: "too_high", icon: (<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="23 18 13.5 8.5 8.5 13.5 1 6" /><polyline points="17 18 23 18 23 12" /></svg>) },

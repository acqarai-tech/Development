...
//     if (n.includes("concierge") || n.includes("reception")) return "🛎️";
//     if (n.includes("garden") || n.includes("lawn")) return "🌿";
//     if (n.includes("kids") || n.includes("play")) return "🧒";
//     if (n.includes("sauna") || n.includes("spa")) return "🧖";
//     if (n.includes("broadband") || n.includes("internet") || n.includes("wifi")) return "📶";
//     if (n.includes("atm")) return "🏧";
//     if (n.includes("elevator") || n.includes("lift")) return "🛗";
//     if (n.includes("bbq") || n.includes("barbeque")) return "🔥";

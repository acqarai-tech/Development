...
//   // ✅ NEW: Mobile responsiveness (NO functionality change)
//   const MOBILE_CSS = `
//     /* ---- Report mobile responsiveness (scoped) ---- */
//     .reportPage { width: 100%; overflow-x: hidden; }
...
//     .compsTable { min-width: 900px; } /* keeps columns readable; scroll on small screens */
...
//       /* Summary cards to single column if they are grid */
//       .summaryGrid {
//         grid-template-columns: 1fr !important;
//         gap: 10px;
//       }

//       /* Charts to one column */
//       .chartsRow {
//         grid-template-columns: 1fr !important;
//         gap: 12px;
//       }

//       /* Tighten paddings on cards if your CSS uses big padding */
//       .card2, .heroCard {
//         padding-left: 14px;
//         padding-right: 14px;
//       }
...
//       {/* ✅ only adds CSS for responsiveness */}
...
export default function Report() {
  ...
  // ✅ Header avatar initials (safe, no functionality change)
  const headerInitials = useMemo(() => {
    const nm =
      (formData?.name ||
        formData?.full_name ||
  ...
  // ✅ Report + Header + Body mobile CSS (NO functionality change)
  const MOBILE_CSS = `
    .reportPage { width: 100%; overflow-x: hidden; background: #f3f4f6; }
    ...
    @media (max-width: 768px) {
      ...
      /* ✅ BODY top section theming + one-line title */
      .topRow{
        padding: 12px 12px !important;
        border-radius: 16px !important;
        margin-top: 12px !important;
        background: #fff7ed !important;              /* light orange */
        border: 1px solid #fed7aa !important;        /* orange border */
      }
      ...
      .reportTitle{
        ...
        color: #9a3412 !important;                   /* brown/orange */
      ...
      .topActions{ width: 100% !important; margin-top: 10px !important; }
      .topActions .btnSecondary{
        width: 100% !important;
    ...
    @media (max-width: 420px) {
      ...
      .reportTitle{ font-size: 20px !important; }
    }
  `;
  ...
  return (
    <div className="reportPage">
      ...
      <div className="rhdr">
        <div className="rhdrInner">
          <div className="rhdrLeft">
            <div className="rhdrLogoBox" aria-hidden="true">A</div>
            <div className="rhdrBrand">ACQAR</div>
          </div>
          ...
          <div className="rhdrRight">
            <div className="rhdrPortal">INVESTOR PORTAL</div>
            <div className="rhdrAvatar" title="User">{headerInitials}</div>
          </div>
        </div>

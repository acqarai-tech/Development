  ...
  <span style={{ opacity: 0.5, fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center", gap: "0.25rem" }}>
    <AEDIcon style={{ fontSize: "0.68rem", lineHeight: 1, filter: "grayscale(1)", opacity: 0.5 }} />299/MO
                ...
                <tbody>
                  ...
                  <TableRow label="Historical Signal Archive" explorer="—" pro="—" elite={<strong>12 months</strong>} proHighlight />
                  <TableRow label="Weekly Market Digest Email" explorer="—" pro="—" elite={<Check />} proHighlight />
                  <TableRow label="AI Summary" explorer="—" pro={<Check color="#B87333" />} elite={<Check />} proHighlight />
                  <TableRow label="Distress Deals" explorer="—" pro={<Check color="#B87333" />} elite={<Check />} proHighlight />
        ...
        <section className="faq-section" style={{ padding: "8rem 2rem", maxWidth: "56rem", margin: "0 auto" }}>
         ...
         <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
  <FAQItem question="What is the Founding Member Offer and how long is it available?" answer="Think of it like getting a VIP deal at Dubai Mall on opening day — but only for the first ones through the door. Founding Members get Acqar Pro at a special low price for the first 3 months. After that, it moves to AED 149/mo. Once the spots are gone, they're gone. No second chance, no waitlist." />
  <FAQItem question="What's the difference between Acqar Pro and Acqar Elite?" answer="Pro is for someone who owns a property or is buying one and wants to stay sharp. You get 10 reports a month, live market signals, and PDF valuations you can share. Elite is for the serious investor or broker — the one with multiple properties and zero tolerance for missing a big move. You get 29 reports, daily market updates, push alerts for every signal, watchlists by area, and a risk score on off-plan projects. It's the difference between watching the game and coaching it." />
  <FAQItem question="Can I cancel my subscription at any time?" answer="Yes. No 12-month contracts. No fine print. No awkward phone call. Cancel whenever you want, straight from your account. Simple as that." />
  <FAQItem question="What exactly is a TRUVALU™ AI Report?" answer="You type in a property — say a 2BR in JVC — and in 60 seconds Acqar tells you what it's actually worth right now. Not a guess. Not a portal estimate from 6 months ago. It gives you the real price based on DLD transactions, an Investment Score out of 100, price forecasts for the next 6 months and 3 years, and a full breakdown of buying costs. You also get a report you can share. It's like having a valuation expert in your pocket — minus the waiting and the fees." />
  <FAQItem question="What is ACQAR SIGNAL™ and how is it different from reading the news?" answer="By the time something lands on Gulf News or Arabian Business, the deal is already done. SIGNAL™ picks up what's happening — off-plan launches, big transactions, regulatory changes — every 3 minutes, from 14 sources at once. It scores each event from S1 (worth watching) to S5 (drop everything). You see it on a live map of Dubai, by area. It's not news. It's intelligence. There's a big difference." />
  <FAQItem question="What is the AI Summary feature in ACQAR SIGNAL™?" answer="You know how you could have 200 things happening in Dubai's market in a single day? The AI Summary takes all of that noise and turns it into a clean, straight-to-the-point breakdown. What happened. Why it matters. What areas are moving. Instead of reading through dozens of signals yourself, the AI reads them all and writes you a summary — like a smart friend who watched the whole market while you were busy and just tells you the important parts." />
  <FAQItem question="What are Distress Deals and how does ACQAR SIGNAL™ help me find them?" answer="A distress deal is when a seller needs to move fast — maybe they have an off-plan payment deadline, a visa issue, or just need cash quickly. These properties often sell below market value. The problem is, by the time most people hear about them, someone else already signed. ACQAR SIGNAL™ picks up the early signals — transaction clusters, price drops, off-plan resale spikes in specific areas — before they become public knowledge. For the right buyer or investor, catching one of these before anyone else can be the difference between a good deal and a great one." />
  <FAQItem question="What does an AI Agent for Dubai Real Estate mean?" answer="Imagine you had a very smart assistant who never sleeps, never takes the weekend off, and reads every property article, every DLD transaction, every Reddit thread about Dubai real estate — all at the same time, every 3 minutes. ACQAR SIGNAL™ is that AI agent. It doesn't just collect the information. It reads it, understands it, scores how important it is, and puts it on your screen instantly. You don't have to search for anything. It finds what matters and brings it to you." />
</div>
        </section>

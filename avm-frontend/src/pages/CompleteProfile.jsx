...
export default function CompleteProfile() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // 1. Use existing session, or create one (anonymous sign-in — session is saved automatically)
      ...
      // 4. Back to chat — pending answer gets restored there
      navigate("/broker", { replace: true });
    } catch (err) {
      console.error(err);
  ...
  const inputStyle = {
    ...
    border: "1px solid #E5E7EB", background: "#FAFAFA", fontSize: 14,
    outline: "none", color: "#111827", fontFamily: "inherit", marginBottom: 12,
  };

  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center",
      background: "#F9FAFB", fontFamily: "Inter, system-ui, sans-serif", padding: 16 }}>
      <div style={{ background: "#fff", borderRadius: 16, padding: "36px 30px", width: "100%",
        maxWidth: 400, boxShadow: "0 8px 30px rgba(0,0,0,0.08)" }}>
        <h2 style={{ margin: "0 0 6px", fontSize: 21, fontWeight: 800, color: "#111827" }}>
          Complete your profile
        </h2>
        <p style={{ margin: "0 0 22px", fontSize: 13, color: "#6B7280", lineHeight: 1.6 }}>
          Enter your details to unlock your answer.
        </p>
        ...
        <input style={inputStyle} placeholder="Phone (optional)" type="tel"
